...
import {
    ...
    Wand2, Video, Loader2, ImageIcon, Maximize2
} from 'lucide-react';
    ...
    if (!shots || shots.length === 0) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] gap-6">
                <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-primary/10 to-accent/10 border border-border flex items-center justify-center">
                    ...
                    >
                        <div className="bg-black/85 backdrop-blur-md border border-border rounded-xl overflow-hidden flex flex-col shadow-2xl">
                            ...
                            <div className="relative aspect-video bg-secondary overflow-hidden border-b border-border">
                                ...
                                <div className="absolute inset-x-0 bottom-0 flex items-center justify-center gap-3 py-2 bg-gradient-to-t from-black/80 to-transparent">
                                    <button
                                        onClick={handlePrev}
