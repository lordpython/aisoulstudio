...
describe('DeAPI Service', () => {
  ...
  describe('Txt2ImgParams Interface', () => {
    it('should support all documented parameters', async () => {
      ...
      const { generateImageWithDeApi } = await import('../../packages/shared/src/services/media/deapiService');
  ...
  describe('Txt2VideoParams Interface', () => {
    it('should support webhook_url parameter', async () => {
      ...
      const { generateVideoWithDeApi } = await import('../../packages/shared/src/services/media/deapiService');
  ...
  describe('Img2VideoParams Interface', () => {
    it('should support last_frame_image and webhook_url parameters', async () => {
      ...
      const { animateImageWithDeApi } = await import('../../packages/shared/src/services/media/deapiService');
  ...
  describe('Model Recommendations', () => {
    it('should export model recommendations', async () => {
      const { MODEL_RECOMMENDATIONS } = await import('../../packages/shared/src/services/media/deapiService');
  ...
  describe('Rate Limiter', () => {
    it('should export rate limiter functions', async () => {
      const { getImg2VideoWaitTime, getImg2VideoQueueLength } = await import('../../packages/shared/src/services/media/deapiService');
  ...
  describe('Tier Detection', () => {
    it('should export tier detection functions', async () => {
      const { detectTier, getRecommendedConcurrency, getCurrentTier } = await import('../../packages/shared/src/services/media/deapiService');
    ...
    it('should return appropriate concurrency for tiers', async () => {
      const { getRecommendedConcurrency } = await import('../../packages/shared/src/services/media/deapiService');
  ...
  describe('Cost Estimation', () => {
    it('should estimate batch costs correctly', async () => {
      const { estimateBatchCost } = await import('../../packages/shared/src/services/media/deapiService');
  ...
  describe('Configuration', () => {
    it('should export configuration check functions', async () => {
      const { isDeApiConfigured, getDeApiConfigMessage } = await import('../../packages/shared/src/services/media/deapiService');
