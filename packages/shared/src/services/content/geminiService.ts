...
} from "../audio-processing/transcriptionService";
...
export { generateImageFromPrompt } from "../media/imageService";

// Re-export from videoService
export { generateVideoFromPrompt } from "../media/videoService";

// Re-export from translationService
export { translateSubtitles } from "../audio-processing/translationService";
